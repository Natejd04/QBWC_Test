class DashboardController < ApplicationController
	...
	def consumer
		@orders = SalesReceipt.where(:c_class => "Consumer Direct").order(sort_column + " " + sort_direction)
	end
	...
	#totaling subtotals
		...
		respond_to do |format|
		    ...
		    # format.csv { send_data Invoice.inv_csv(@inv_temp), filename: "orders-#{Time.now.strftime("%d-%m-%Y %k%M")}.csv" }
  		end		
	end 
