...
# def request all invoices (will filter results at the end)
        {
            :invoice_query_rq => {
                ...
                :max_returned => 10,
                :txn_date_range_filter => {"from_txn_date" => Date.today - 7, "to_txn_date" => Date.today + 1.days},
    ...
    def handle_response(r, session, job, request, data)
        ...
        if r['invoice_ret'].is_a? Array 
            ...
            r['invoice_ret'].each do |qb_item|
                if qb_item['template_ref']['full_name'] == "* Zing Whls/Consumer Invoice V2"
                    item_data = {}
        ...
        elsif !r['invoice_ret'].blank? && r['invoice_ret']['template_ref']['full_name'] == "* Zing Whls/Consumer Invoice V2"
            item_data = {}
